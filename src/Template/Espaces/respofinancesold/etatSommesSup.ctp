...
<table cellspacing="0" border="0">
    ...
    <tr>
        <td colspan=7 height="21" align="center" valign=bottom bgcolor="#FFFFFF"><b><u><font face="Times New Roman" size=3>Etat des sommes dues pour heures supplémentaires  .</font></u></b></td>
    </tr>
    ...
    <tr>
        ...
        <td height="20" colspan=2 align="left" valign=bottom bgcolor="#FFFFFF"><font face="Calibri"></font> : <?php echo $professeur->nom_prof." ".$professeur->prenom_prof;?></td>

        <td height="20" colspan=2 align="right" valign=bottom bgcolor="#FFFFFF"><font face="Open Sans">S.O.M&nbsp;</font></td>
        <td height="20" colspan=1 align="left" valign=bottom bgcolor="#FFFFFF"><font face="Calibri"> : <?php echo $professeur->somme?></font></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td align="left" valign=bottom bgcolor="#FFFFFF"><font face="Calibri"> :<?php echo $professeur->specialite?></font></td>
        <td align="left" valign=bottom bgcolor="#FFFFFF"><font face="Calibri"></font></td>
        <td align="left" valign=bottom bgcolor="#FFFFFF"><font face="Calibri" size=3></font></td>
        <td align="left" valign=bottom bgcolor="#FFFFFF"><font face="Calibri" size=3></font></td>
        <td align="left" valign=bottom bgcolor="#FFFFFF"><font face="Calibri" size=3></font></td>
    ...
    <tr>
        ...
        <td align="left" colspan=3 align="left" valign=bottom bgcolor="#FFFFFF"><font face="Calibri">:<?php echo $professeur->universite?></font></td>
    ...
    $q=floor(count($paimentsup->sup_heures)/2);

    foreach ($paimentsup->sup_heures as $vacation){
        echo '<tr height="15">';
    ...
    <tr>
        ...
        <td align="left" colspan="3" valign=bottom><font face="Calibri"><?php echo $professeur->nom_prof." ".$professeur->prenom_prof;?></font></td>
        <td align="left" valign=bottom><font face="Calibri"></font></td>
        <td align="left" valign=bottom><font face="Calibri"></font></td>
        <td align="left" valign=bottom><font face="Calibri"></font></td>
        <td align="left" valign=bottom><font face="Calibri"></font></td>
    ...
    <tr>
        <td colspan=7 height="21" align="center" valign=bottom><b><u><font face="Open Sans">Décompte des heures supplémentaires</font></u></b></td>
    </tr>
    <tr>
        <td style="border-bottom: 1px solid #000000" height="21" align="left" valign=bottom><font face="Calibri"></font></td>
        <td style="border-bottom: 1px solid #000000" align="left" valign=bottom><font face="Calibri"></font></td>
    ...
    <tr>
        ...
        <td style="border-bottom: 1px solid #000000; border-right: 1px solid #000000" colspan=2 align="center" valign=bottom bgcolor="#C0C0C0"><font face="Open Sans">Impôts à 38 % </font></td>
    ...
    <tr>
        ...
        <td class="colorer" style="border-bottom: 1px solid #000000; border-right: 1px solid #000000" colspan=2 align="center" valign=bottom sdnum="1033;0;_-* #,##0.00 _€_-;-* #,##0.00 _€_-;_-* &quot;-&quot;?? _€_-;_-@"><font face="Calibri" color="#000000"><?php echo number_format((float)($total*38/100), 2, ',', '')?></font></td>
        <td class="colorer" style="border-bottom: 1px solid #000000; border-right: 1px solid #000000" colspan=2 align="center" valign=bottom sdval="0" sdnum="1033;0;#,##0.00"><font face="Calibri" color="#000000"><?php echo number_format((float)($total-($total*38/100)), 2, ',', '')?></font></td>
    ...
    <tr>
        ...
        <td height="21" colspan=4 align="left" * valign=bottom><font face="Calibri"><?php
                ...
                $number = number_format((float)($total-($total*38/100)), 2, ',', '');
                $num=(string)$number;
                $pieces = explode(",", $num);
    ...
    <tr>
        ...
        <td align="left" valign=bottom><font face="Calibri"></font></td>
        <td align="left" valign=bottom><font face="Calibri"></font></td>
        <td align="left" colspan=5 valign=bottom><font face="Open Sans">KHOURIBGA LE : <?php // echo $newDate = date("d/m/Y", strtotime($paimentsup->datepaiment));?></font></td>
