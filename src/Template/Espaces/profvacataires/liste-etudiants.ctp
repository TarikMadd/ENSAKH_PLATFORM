        ...
        <div  class="col-md-6" style="width: 100% !important; margin-left: 0 !important;">
            ...
            <div class="box box-info">
                <div id="main_table" class="box-header with-border">
                    ...
                    <h3 class="box-title txt-annee" style="float: right;" >ANNÉE UNIVERSITAIRE : <?php echo $anneeScolaire[0]['libile']; ?><br/><br/><span style="float: right" ><?php echo ' SEMESTRE : '.$semestre[0]['semestres_lib']; ?></span></h3>
                </div><!-- /.box-header -->
                            ...
                            if((isset($haveMore) && $haveMore) || !isset($haveMore) || $for_pv == 1){
                                if($access_type !== "consulter")  {
                                    echo '<label class="btn btn-default btn-file" style=" margin-left: 10px; ">';
                                        echo 'Parcourir <input name="csv_notes" type="file" hidden>';
                                    echo '</label>';
                                    if($first_time){
