        ...
        <div class="col-md-4">
            ...
            <div class="box box-widget widget-user">
                ...
                <div class="widget-user-header bg-aqua-active">
                    <h3 class="widget-user-username"> <?php echo $data['PROF_DATA'][0]['nom_vacataire'].' '.$data['PROF_DATA'][0]['prenom_vacataire']; ?> </h3>
                    <h5 class="widget-user-desc">Prof vacataire</h5>
                </div>
                        ...
                        <div class="box-footer no-padding">
                            <ul class="nav nav-stacked">
                                <?php foreach ($data['classes']['modeles'] as $modele) : ?>
                                    <form action="/Ensaksite/profvacataires/verifier-code" method="POST">
