                    ...
                    <table class="table table-hover">
                        ...
                        <tr>
                            ...
                            <td class="actions" style="white-space:nowrap">
                                                 <?php
                                                 if($documentsVacataire->etatdemande=='Delivré')
                                                 {
                                                 echo $this->Html->link(__('Imprimer'), ['action' => 'imprimerDocumentt', $documentsVacataire->document_id,$documentsVacataire->vacataire_id], ['class'=>'btn btn-warning btn-xs']  ) ;
                                                 echo " ";
                                                 echo $this->Html->link(__('Supprimer'), ['action' => 'supprimerDocument', $documentsVacataire->id], ['class'=>'btn btn-danger btn-xs']  ) ;
