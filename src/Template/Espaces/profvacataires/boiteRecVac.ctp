...
<div>
    ...
    <div class="content-wraper">
        ...
        <section class="content">
            <div class="row">
                <div class="col-md-3">
                    <a href="<?php echo $this->Url->build('/profvacataires/envoyerNvVac'); ?>" class="btn btn-primary btn-block margin-bottom">Composer un nouveau message</a>
                    ...
                    <div class="box box-solid">
                        ...
                        <div class="box-body no-padding">
                            <ul class="nav nav-pills nav-stacked">
                                <li class="active"><a href="<?php echo $this->Url->build('/profvacataires/boiteRecVac'); ?>"><i class="fa fa-inbox"></i> Boîte de réception
                                        <?php if(!isset($displaySent)){ ?>  <span class="label label-primary pull-right"> <?php $c =0; foreach ($mesMsgs as $m){ $c++; } echo $c; ?></span><?php } ?></a></li>
                                <li><a href="<?php echo $this->Url->build('/profvacataires/getMsgsEnvoye'); ?>"><i class="fa fa-envelope-o"></i> Messages envoyés</a></li>
                ...
                <div class="col-md-9">
                    <div class="box box-primary">
                        ...
                        <!-- /.box-header -->
                        <form action="/Ensaksite/profvacataires/supprimerMsg" method="post">
                            <div class="box-body no-padding">
                                ...
                                <div class="table-responsive mailbox-messages">
                                    ...
                                    <table class="table table-hover table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <td class="mailbox-name"><a href="<?php $id = $msg['username']; echo $this->Url->build('/profvacataires/lireMsgVac/'.$msg['id']); ?>"><?php  if(strcmp($msg['role'],'resposcolarite') == 0) echo 'SCOLARITE '.$msg['username']; else echo 'ETUDIANT '.$msg['username']; ?></a></td>
                            ...
                            <div class="box-body no-padding">
                                ...
                                <div class="table-responsive mailbox-messages">
                                    ...
                                    <table class="table table-hover table-striped">
                                        ...
                                        <tr>
                                            <td class="mailbox-star"><a href="#"><i class="fa fa-star text-yellow"></i></a></td>
                                            <td class="mailbox-name"><a href="<?php $id = $msg['username']; echo $this->Url->build('/profvacataires/lireMsgVac/readSN.'.$msg['id']); ?>"><?php  if(strcmp($msg['role'],'resposcolarite') == 0) echo 'SCOLARITE '.$msg['username']; else echo 'ETUDIANT '.$msg['username']; ?></a></td>
                                            <td class="mailbox-subject"><b><?php  echo $msg['sujet']; ?></b> <?php  echo substr($msg['contenu'], 0,50)."..."; ?>
                                            </td>
                                            <td class="mailbox-attachment"></td>
                                        ...
                                        <tr>
                                            <td class="mailbox-star"><a href="#"><i class="fa fa-star text-yellow"></i></a></td>
                                            <td class="mailbox-name"><a href="<?php  echo $this->Url->build('/profvacataires/lireMsgVac/readSD.'.$msg['id']); ?>"><?php  if(strcmp($msg['role'],'resposcolarite') == 0) echo 'SCOLARITE '.$msg['username']; else echo 'ETUDIANT '.$msg['username']; ?></a></td>
                                            <td class="mailbox-subject"><b><?php  echo $msg['sujet']; ?></b> <?php  echo substr($msg['contenu'], 0,50)."..."; ?>
                                            </td>
                                            <td class="mailbox-attachment"></td>
                                            <td class="mailbox-date"><?php echo "envoyé le:   ".$msg['date']; ?></td>
