...
<div>
    ...
    <div class="content-wrappe">
        ...
        <section class="content">
            <div class="row">
                <div class="col-md-3">
                    <a href="<?php echo $this->Url->build('/profvacataires/envoyerNvVac'); ?>" class="btn btn-primary btn-block margin-bottom">Composer</a>
                        ...
                        <div class="box-body no-padding">
                            ...
                            <div class="mailbox-read-info">
                               <h3>Sujet: <?php  echo $msg['sujet']; ?></h3>
                                ...
                                <h5><b>De : </b><?php  if(strcmp($msg['role'],'resposcolarite') == 0) echo 'Scolarité '.$msg['username']; else echo 'Etudiant '.$msg['username']; ?></h5>
                                <?php endif ?>

                                <?php if(strcmp($me,'me') == 0): ?>
                                <h5><b>A : </b><?php  if(strcmp($msg['role'],'resposcolarite') == 0) echo 'Scolarité '.$msg['username']; else echo 'Etudiant '.$msg['username']; ?> </h5>
                                <?php endif ?>
