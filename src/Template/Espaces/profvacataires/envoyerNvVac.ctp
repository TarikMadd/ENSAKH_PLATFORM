...
<div >
    ...
    <div>
        ...
        <section class="content">
            <div class="row">
                <div class="col-md-3">
                    <a href="<?php echo $this->Url->build('/profvacataires/boiteRecVac'); ?>" class="btn btn-primary btn-block margin-bottom">Retour à la Boîte de réception</a>
                    ...
                    <div class="box box-solid">
                        ...
                        <div class="box-body no-padding">
                            <ul class="nav nav-pills nav-stacked">
                                <li><a href="<?php echo $this->Url->build('/profvacataires/boiteRecVac'); ?>"><i class="fa fa-inbox"></i> Boîte de réception
                ...
                <div class="col-md-9">
                    <div class="box box-primary">
                        ...
                        <!-- /.box-header -->
                        <form method="post" action="/Ensaksite/profvacataires/envoyermsg" enctype="multipart/form-data">
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <select required class="form-control" name="typeDest" onChange="top.location.href='/Ensaksite/profvacataires/getDestinataire/'+this.options[selectedIndex].value">
                                ...
                                <div class="form-group">
                                    ...
                                    <table width="80%">
                                        <tr>
                                            <td>
                                                <select  required class="form-control" name="filiereEtudiant" onChange="top.location.href='/Ensaksite/profvacataires/getEtudiantsParFiliere/'+this.options[selectedIndex].value">
