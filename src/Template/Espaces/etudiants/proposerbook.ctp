<div class="container">
    <div class="well well-sm">
        ...
        <form class="form-horizontal" method="post" action="<?php echo $this->Url->build('/etudiants/proposerbook', true) ?> " enctype="multipart/form-data">
            <?php foreach ($coord as $coord): ?>
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control"  name="nom" value="<?php echo $coord['nom_fr']; ?> "   required >
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label" >Prenom</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control"     name="prenom" value="<?php echo $coord['prenom_fr']; ?>"  >
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label" >CNE/SOM</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control"  name="cne" value="<?php echo $coord['cne']; ?>"   required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label" >Email</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control"   name="email" value="<?php echo $coord['cne']; ?>"  required>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-3 col-sm-9">
                            ...
                            <button type="button" class="btn btn-danger"><a href="<?php echo $this->Url->build('/etudiants/proposerbook'); ?>"><font color="white" >Reset</font></a></button>
                        </div>
                    </div>
