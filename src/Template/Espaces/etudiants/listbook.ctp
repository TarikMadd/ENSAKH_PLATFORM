...
<?php echo $this->Form->create('Post',array('id' => 'textBox', 'type' => 'post','url' => array('controller' => 'etudiants', 'action' => 'recherchebook'))); ?>
                ...
                <?php  echo $this->Form->button(__(' cliquez ici pour chercher')) ;?>
                        <button type="button" class="btn btn-warning"><a href="<?php echo $this->Url->build('/etudiants/listcategorie'); ?>"><font color="white" >Lister les ouvrage par Catégorie</font></a></button>
...
<form   method="post" action=" <?php echo $this->Url->build('/etudiants/recherchecatbook', true) ?>">
    <select name="choix" >
                ...
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-md-6">
                                <form method="post" action=" <?php echo $this->Url->build('/etudiants/detailbook', true) ?>"">
