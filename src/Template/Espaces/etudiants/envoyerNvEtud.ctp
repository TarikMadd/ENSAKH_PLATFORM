...
<div >
    ...
    <div>
        ...
        <section class="content">
            <div class="row">
                <div class="col-md-3">
                    <a href="<?php echo $this->Url->build('/etudiants/boiteRecEtud'); ?>" class="btn btn-primary btn-block margin-bottom">Retour à la Boîte de réception</a>
                ...
                <div class="col-md-9">
                    <div class="box box-primary">
                        ...
                        <!-- /.box-header -->
                        <form method="post" action="/Ensaksite/etudiants/envoyermsg" enctype="multipart/form-data">
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <select required class="form-control" name="typeDest" onChange="top.location.href='/Ensaksite/etudiants/getDestinataire/'+this.options[selectedIndex].value">
                                            ...
                                            <option value="professeur" <?php if(strcmp($selected, 'professeur') == 0) : ?> selected <?php endif ?> >Professeur</option>
                                        </select>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="destinataire">
                                        <?php foreach ($typeDest as $dest): ?>
                                        <option value="<?php echo $dest['id']; ?> " ><?php echo "professeur: ".$dest['nom']."  =>Module :".$dest['module']; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                    <?php endif ?>
                                </div>
                                <div class="form-group">
                                    <input class="form-control" placeholder="Sujet:" name="sujet" required>
                                </div>
                                <div class="form-group">
