                ...
                <div class="well profile">
                    ...
                    <div class="col-xs-12 divider text-center">
                        <div class="col-xs-12 col-sm-4 emphasis">
                            ...
                            <form method="post"  name="reserver" action=" <?php echo $this->Url->build('/etudiants/reserverbook', true) ?>"">
                        ...
                        <div class="col-xs-12 col-sm-4 emphasis">
                            ...
                            <form method="post"  name="add" action=" <?php echo $this->Url->build('/etudiants/votebook', true) ?>"">
                      ...
                      <h2><strong><?php echo $book['nbExemplaire']; ?></strong></h2>
                            ...
                            <div class="btn-group dropup btn-block">
                                ...
                                <ul class="dropdown-menu text-left" role="menu">
                                    <li><a href="<?php echo $this->Url->build('/etudiants/listbook', true) ?>"><span class="fa fa-th-list pull-right"></span> Liste des ouvrages  </a></li>
                                    <li><a href="<?php echo $this->Url->build('/etudiants/listcategorie', true) ?>"><span class="fa fa-windows pull-right"></span> Liste par catégories </a></li>
                                    <li><a href="<?php echo $this->Url->build('/etudiants/proposerbook', true) ?>"><span class="fa fa-eyedropper pull-right"></span> Proposer des ouvrages</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
