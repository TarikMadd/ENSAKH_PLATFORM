...
Occupant la fonction de : <br/><br/>
   ...
   <span style="font-weight: bold;"> ET l’Ecole Nationale des Sciences Appliquées Khouribga</span> (ENSA K) représentée par son Directeur, Monsieur<span style="font-weight: bold;"> Adib JENNANE</span>, concernant le stage de la <span style="font-weight: bold;">  2ème </span> Année du Cycle Ingénieur  
</p>

<p> <p> Nom : <span style="font-weight: bold;"><?= $donne[0]['nom_fr'] ?></span>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Prénom : <span style="font-weight: bold;"><?=$donne[0]['prenom_fr']?></span> <br/>
Niveau d’études : <span style="font-weight: bold;">  2ème  Année Cycle Ingénieur  </span>  <br/> 
...
Le stage à effectuer est un stage d’<span style="font-weight: bold;">Ingénieur Adjoint</span>, dont l’objectif est de réaliser un projet complet en situation professionnelle d’ingénieur avec l’appui des compétences et des ressources de la filière.
</p>
...
<p> <span class="article">  Article 6</span> : 
...
<p>
    Le stage étant obligatoire, le stagiaire est considéré comme ayant donné son consentement aux clauses de la présente convention.</p>
