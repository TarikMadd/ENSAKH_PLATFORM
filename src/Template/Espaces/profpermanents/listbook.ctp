...
<?php echo $this->Form->create('Post',array('id' => 'textBox', 'type' => 'post','url' => array('controller' => 'Profpermanents', 'action' => 'recherchebook'))); ?>
                ...
                <?php  echo $this->Form->button(__(' cliquez ici pour chercher')) ;?>
                        <button type="button" class="btn btn-warning"><a href="<?php echo $this->Url->build('/Profpermanents/listcategorie'); ?>"><font color="white" >Lister les ouvrage par Catégorie</font></a></button>
...
<form   method="post" action=" <?php echo $this->Url->build('/Profpermanents/recherchecatbook', true) ?>">
    <select name="choix" >
