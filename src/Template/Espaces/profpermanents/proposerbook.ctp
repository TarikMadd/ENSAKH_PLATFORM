<div class="container">
    <div class="well well-sm">
        ...
        <form class="form-horizontal" method="post" action="<?php echo $this->Url->build('/Profpermanents/proposerbook', true) ?> " enctype="multipart/form-data">
            <?php foreach ($coord as $coord): ?>
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control"  name="nom" value="<?php echo $coord['nom_prof']; ?> "   required >
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label" >Prenom</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control"     name="prenom" value="<?php echo $coord['prenom_prof']; ?>"  >
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control"   name="email" value="<?php echo $coord['email_prof']; ?>"  required>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-3 col-sm-9">
                            ...
                            <button type="button" class="btn btn-danger"><a href="<?php echo $this->Url->build('/Profpermanents/proposerbook'); ?>"><font color="white" >Reset</font></a></button>
                        </div>
                    </div>
