...
<div class="container">
    <div class="well well-sm">
        <h2><strong>résultats de recherche</strong></h2>
                        <button type="button" class="btn btn-warning"><a href="<?php echo $this->Url->build('/Profpermanents/listbook'); ?>"><font color="white" >revenir au menu principale </font></a></button>
