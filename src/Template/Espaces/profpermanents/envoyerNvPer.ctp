            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <div class="box box-primary">
                        ...
                        <!-- /.box-header -->
                        <form method="post" action="/Ensaksite/profpermanents/envoyermsg" enctype="multipart/form-data">
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <select required class="form-control" name="typeDest" onChange="top.location.href='/Ensaksite/profpermanents/getDestinataire/'+this.options[selectedIndex].value">
                                ...
                                <div class="form-group">
                                    ...
                                    <table width="80%">
                                        <tr>
                                            <td>
                                                <select  required class="form-control" name="filiereEtudiant" onChange="top.location.href='/Ensaksite/profpermanents/getEtudiantsParFiliere/'+this.options[selectedIndex].value">
