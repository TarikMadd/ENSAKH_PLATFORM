...
<body>
    ...
    <h2 style=" text-align: center;"> <strong>Permission d'absence</strong></h2></br>
        ...
        <p style=" text-align: right;">Signature du fonctionnaire : </p> </br>
              

                 
<footer>  <p style="border-radius: 6px;"> Note : Il est interdit au fonctionnaire de sortir avant de délivrer une copie de cette certificat . </p> </footer>
