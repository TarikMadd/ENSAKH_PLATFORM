    ...
    <div class="col-md-12">
      ...
      <div class="box box-primary">
        ...
        <?= $this->Form->create($mission, array('role' => 'form')) ?>
          ...
          <?php
            // echo $this->Form->input('date_depart', array('label' => 'Date de depart', 'dateFormat' => 'DMY'));
            // echo $this->Form->input('date_arrivee', array('label' => 'Date d\'arrive', 'dateFormat' => 'DMY'));
            ...
            echo $this->Form->hidden('fonctionnaire_id', ['options' => $fonctionnaires ,'empty' => true]);
