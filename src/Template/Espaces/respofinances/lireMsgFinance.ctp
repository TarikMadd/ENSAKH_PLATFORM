...
<div>
    ...
    <div class="content-wrappe">
        ...
        <section class="content">
            <div class="row">
                <div class="col-md-3">
                    <a href="<?php echo $this->Url->build('/respofinances/envoyerNvFinance'); ?>" class="btn btn-primary btn-block margin-bottom">Composer</a>
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body no-padding">
                            ...
                            <div class="mailbox-read-info">
                                ...
                                <h5>De: <?php  echo $msg['username']; ?>
                                    <span class="mailbox-read-time pull-right"><?php  echo $msg['date']; ?></span></h5>
                            </div>
                            <!-- /.mailbox-read-info -->
                            ...
                            <ul class="mailbox-attachments clearfix">
                                <li>
                                    ...
                                    <div class="mailbox-attachment-info">
                                        <a href="<?php  echo $msg['piecejointe']; ?>" class="mailbox-attachment-name"><i class="fa fa-paperclip"></i>  <?php  echo $msg['piecejointe']; ?>  </a>
