...
<center><div style="border:solid 2px; width: 200px;padding: 15px"><strong>ORDRE DE MISSION</div><br>
<p><b><i>Le Directeur de l'école nationnale de sciences appliquées certifie que :</i></b></p></center>
<div class="row">
    <div class="col-xs-10" style="margin-left:150px">
      <p>Mr/Mme: <?php echo $fonc['nom_fct']." ".$fonc['prenom_fct']; ?><br>Doti:<br>ENSA KHOURIBGA<br>Est autorisé(e) à effectuer les missions ci-dessous indiquées:</strong></p>
    </div>
</div>
<table border="1">
    <tr>
