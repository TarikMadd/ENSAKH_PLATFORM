                    ...
                    <div class="box-body">
                        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                            ...
                            <tr>
                                ...
                                $gra=$vacataire->grades[0]['categorie'];
                                ...
                                foreach ($vacataire->grades as $grade){
                                    ...
                                    if(($grade['_joinData']['datedebut'] > $date)  and ($grade['_joinData']['datedebut']->format('Y-m-d') <=$d )){
                                        $taux=$grade->taux;
                                        $date=$grade['_joinData']['datedebut'];
                                        $gra=$grade->categorie;
                                    }
                                ...
                                foreach ($vacataire->vacations as $vacations)
                                ...
                                $impot=number_format((float)($brut*17/100), 2, '.', '');
