                ...
                <div class="row">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <input type="number" name="nbHeure" class="form-control" id="nbHeure" placeholder="Enter nombre d'heures" min="1" max="30" required>
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <?php
                            foreach($vacatairees as $vacataire){
                                echo "<option value ='$vacataire->id'>".$vacataire->nom_vacataire." ".$vacataire->prenom_vacataire."</option>";
                            }
                            ?>
                            </select>
                        </div>
