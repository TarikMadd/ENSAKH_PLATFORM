...
<div class="row">
      ...
      <div class="col-xs-11">
        ...
        Bénéficiaire &nbsp;&nbsp;&nbsp;:<b> <?php echo $prof['nom_prof']." ".$prof['prenom_prof']; ?></b><br>
        Adresse &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <b>ENSA KHOURIBGA</b><br>
        Domiciliation&nbsp;&nbsp; :<br><br>
        <b>Pièces justificatives:</b>
        <ul>
            <li>copie de l’état des sommes dues</li>
            <li>copie de l’Ordre de mission</li>
            <li>Copie de la décision</li>
