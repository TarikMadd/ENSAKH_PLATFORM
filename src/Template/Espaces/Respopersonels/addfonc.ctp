...
.form-style-3 textarea{
  ...
  echo $this->Form->input('username',array(
        ...
        <?php $options = [
            ...
            'resposcolarite'=> 'responsable de scolarité',
            'respopersonel'=> 'responsable personel' ,
            'respobiblio'=> 'responsable bibliothèque',
            'respofinance'=> 'responsable finance' ,
            'respostock'=>  'responsable de stock',
            'respostage' =>'responsable de stage'];

        echo $this->Form->select('dawr', $options, ['default' => true]);?>
    </fieldset>
    </div>
    <div class="form-style-3" id="contenu">
     <fieldset>
        <legend>Informations d'un nouveau fonctionnaire</legend>
        <?php
