         ...
         echo $this->Form->input('somme',array('label'=>'SOMME',
            ...
            echo $this->Form->input('prenom_fct',array(
                        ...
                        'label'=> "PRENOM PROFESSEUR",
                                                                  ...
                                                                  echo $this->Form->control('grade', ['options' => $nomtab,'label'=>'GRADE','style'=>'width:460px','placeholder'=> "Choisissez le Grade",'onchange'=>"populateCategorie('grade','categorie')"]);
                                                                                   echo $this->Form->control('categorie', ['options'=>"",'label'=>'CATEGORIE','style'=>'width:460px']);
                                ...
                                <div class="col-md-6">
                                     <div class="box-body">
                                      ...
                                      <div class="form-group">
                                          ...
                                          <input style="width:410px" name="date_Recrut"type="text" class="form-control"  data-inputmask="'alias': 'dd/mm/yyyy'" data-mask>
                                        </div>
                                          </div></div>
                                    </div>
                                 </div>
