<section class="content-header">
    <h1>
        <?php echo __('Les données du fonctionnaire '); ?>
    </h1>
    <ol class="breadcrumb">
        <li>
            ...
            <div class="box box-solid">
                ...
                <div class="box-body">
                    ...
                    <?php echo $this->form->create(); ?>
                        <dt><?= __('Nom') ?></dt>
                        <dd>
                            <?php echo $profpermabis[0]['nom_fct'] ?>
                        </dd>
                        <dt><?= __('Prénom') ?></dt>
                        <dd>
                            <?php echo $profpermabis[0]['prenom_fct'] ?>
                        </dd>
                        <dt><?= __('CIN') ?></dt>
                        <dd>
                        ...
                        <dd>
                            <?php echo $profpermabis[0]['lieuNaissance'] ?>
                        </dd>
                        ...
                        <dt><?= __('Email') ?></dt>
                        <dd>
                            <?php echo $profpermabis[0]['email'] ?>
                        </dd>
                        <dt><?= __('Genre') ?></dt>
                        <dd>
                            <?php echo $profpermabis[0]['genre'] ?>
                        </dd>
                        <dt><?= __('Nombre d\'enfants') ?></dt>
                        <dd>
                            <?php echo $profpermabis[0]['nbr_enfants'] ?>
                        </dd>
                        <dt><?= __('Passage de l\'exam') ?></dt>
                        <dd>
                            <?php echo $profpermabis[0]['isPassExam'] ?>
                        </dd>
