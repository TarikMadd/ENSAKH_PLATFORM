              ...
              {?>
               <tr>
                              ...
                              <td class="actions" style="white-space:nowrap">
                                <?= $this->Html->link(__('Echelon Suivant'), ['action' => 'passageGlobalFct', $professeursGrade->id,$professeursGrade->echelon,$professeursGrade->grade->nomGrade], ['class'=>'btn btn-warning btn-xs']  ) ?>
