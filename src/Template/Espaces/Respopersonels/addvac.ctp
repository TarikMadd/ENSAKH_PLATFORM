     ...
     <fieldset class="panel-heading">
        ...
        <?php
         echo $this->Form->input('somme',array('label'=>'SOMME',
            ...
            echo $this->Form->input('nbr_enfants',array('label'=>'Nombre Enfants',
                        'style' => "background-color:#FFFFFF; color:#1B4F72;width:460px; font-weight:bold", 'default' => '0', 'type' => 'number'
                        ));
            ...
            <div class="form-group" style='width:460px' >
                            ...
                            <?php
                            echo  "<select name=\"situationFamiliale\" id='situation_familiale' class=\"form-control\" >
...
echo $this->Form->control('grade', ['options' => $nomtab,'label'=>'GRADE','style'=>'width:460px','placeholder'=> "Choisissez le Grade",'onchange'=>"populate('grade','sousgrade')", 'required']);
echo $this->Form->control('sousgrade', ['options'=>"",'label'=>'CLASSE','style'=>'width:460px','onchange'=>"populateBis('sousgrade','echelon','grade')", 'required']);
echo $this->Form->control('echelon', ['options' => "",'label'=>'ECHELON','style'=>'width:460px', 'required']);
            ...
            <div class="row">
             ...
             <label style='margin-left:10px'>DATE DE RECRUTEMENT</label>
                                ...
                                <div class="col-md-6">
                                     <div class="box-body">
                                      ...
                                      <div class="form-group">
                                          ...
                                          <input style="width:410px" name="dateRecrut"type="text" class="form-control"  data-inputmask="'alias': 'yyyy/mm/dd'" data-mask>
                                        </div>
                                          </div></div>
                                    </div>
                                 </div>
              ...
              <?php
                echo $this->Form->input('nomdepart', ['label'=>'NOM DEPARTEMENT','options' => $tabNom,'style'=>"width:460px"]);
                    ...
                    <div class="col-md-6">
                         <div class="box-body">
                          ...
                          <div class="form-group">
                              ...
                              <input style="width:410px" name="dateAffectation" type="text" class="form-control"  data-inputmask="'alias': 'yyyy/mm/dd'" data-mask>
                            </div>
                              </div></div>
                        </div>
                     </div>
            ...
            echo $this->Form->input('nb_heures',array('label'=>'Nombres d\'heures',
