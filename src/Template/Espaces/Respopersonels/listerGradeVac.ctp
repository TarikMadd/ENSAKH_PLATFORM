...
<section class="content-header">
   ...
   <h1> <div class="pull-right">
       <?= $this->Html->link(__('Imprimer la Liste'), ['action' => 'printListegradevac'], ['class'=>'btn btn-info btn-xs','class'=>'glyphicon glyphicon-duplicate']) ?> </div></h1> 
...
{
$suivant[$i]=$professeursGrade->vacataire_id;
$i++;
}?>
      ...
      <div class="box" >
        ...
        <div class="box-body table-responsive no-padding">
         <div class="panel panel-primary">
             <div class="pull-right"><?= $this->Html->link(__('Affecter Grade'), ['action' => 'affecterGradeVac'], ['class'=>'btn btn-success btn-xs']) ?></div>

                    <div class="panel-heading"><h4>    - Liste des grades actuels pour les professeurs vacataires :
</h4>
                    </div>
