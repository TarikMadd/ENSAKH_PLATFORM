  ...
  <div class="row">
    <div class="col-md-3 col-sm-6 col-xs-12">
      <div class="info-box">
        ...
        <div class="info-box-content">
          <span class="info-box-text">Demandes Delivrées</span>
    ...
    <div class="col-md-3 col-sm-6 col-xs-12">
      <div class="info-box">
        ...
        <div class="info-box-content">
          <span class="info-box-text">Demandes Envoyées</span>
          ...
          <div class="col-md-8">
            ...
            <div class="box box-warning direct-chat direct-chat-warning">
              <div class="box-header with-border">
                <h3 class="box-title">Quelques Statistiques : </h3>
...
<?php
        ...
        <div class="box box-primary">
          <div class="box-header with-border">
            <h3 class="box-title">Demandes plus récentes : </h3>
          ...
          <ul class="timeline">
            ...
            <li>
              ...
              <div class="timeline-item">
                ...
                <h3 class="timeline-header">Dossiers à traiter :<a href="#"></a> </h3>
                <?php
