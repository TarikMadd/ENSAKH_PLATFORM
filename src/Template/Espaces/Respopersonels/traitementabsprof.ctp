<div class="container">
     ...
     <div class="panel panel-primary">
                  ...
                  <table class="table table-user-information">
                    <tbody>
                      <tr>
                        ...
                        <td><i><?php echo $_SESSION['demandes'][0]['nom_prof']." ".$_SESSION['demandes'][0]['prenom_prof']?></i></td>
                      </tr>
                      <tr>
          ...
          { ?>
            ...
            <a href="../imprimerabsperm"><button class="btn btn-block" name="valider" style="background-color: #efefef; color: black;"><i class="fa fa-fw fa-print"></i>Imprimer</button></a>
