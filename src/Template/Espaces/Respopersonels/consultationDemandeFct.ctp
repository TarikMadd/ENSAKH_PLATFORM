...
?>
              ...
              <td><?= h($documentsProfesseur->fonctionnaire->somme)?></td>
                 ...
                 <td class="actions" style="white-space:nowrap">
                                                 ...
                                                 {
                                                     echo $this->Html->link(__('Approuver'), ['action' => 'approuverDemande', $documentsProfesseur->document_id,$documentsProfesseur->fonctionnaire_id], ['class'=>'btn btn-info btn-xs']  );
