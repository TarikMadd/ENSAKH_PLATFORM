                    ...
                    <table class="table table-hover">
                        ...
                        <?php foreach ($fonctionnairesDocuments as $documentsProfesseur): ?>
                            ...
                            <td class="actions" style="white-space:nowrap">
                                ...
                                {
                                    echo $this->Html->link(__('Approuver'), ['action' => 'approuverDemandeFct', $documentsProfesseur->document_id,$documentsProfesseur->fonctionnaire_id], ['class'=>'btn btn-info btn-xs']  );

                                }
                                elseif($documentsProfesseur->etatdemande=='En cours de traitement')
                                {
                                    echo $this->Html->link(__('Imprimer'), ['action' => 'imprimerDocumentFct', $documentsProfesseur->document_id,$documentsProfesseur->fonctionnaire_id], ['class'=>'btn btn-warning btn-xs']  ) ;
