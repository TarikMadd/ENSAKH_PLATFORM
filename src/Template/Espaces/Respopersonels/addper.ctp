...
<section class="content" style='width:600px'>
    <div class="box box-primary">
     ...
     <fieldset class="panel-heading">
        ...
        <?php
         echo $this->Form->input('somme',array('label'=>'Numero de somme',
          ...
          echo $this->Form->input('genre',['options' =>[ 'male' =>'Male', 'femelle'=> 'Femelle']], array(
            ...
            echo $this->Form->input('Poste',array( 'style' => "background-color:#FFFFFF; color:#1B4F72; width:460px;font-weight:bold",
                    ...
                    <div class="col-md-6">
                         <div class="box-body">
                          ...
                          <div class="form-group">
                              ...
                              <input style="width:410px" name="date_debut" type="text" class="form-control"  data-inputmask="'alias': 'yyyy/mm/dd'" data-mask>
                            </div>
                              </div></div>
                        </div>
                     </div>
