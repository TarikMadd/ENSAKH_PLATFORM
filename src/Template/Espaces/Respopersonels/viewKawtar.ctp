<div class="container">
     ...
     <div class="panel panel-primary">
                  ...
                  <table class="table table-user-information">
                    <tbody>
                      <tr>
                        ...
                        <td><i><?php echo $_SESSION['demandes'][0]['nom_fct']." ".$_SESSION['demandes'][0]['prenom_fct']?></i></td>
                      </tr>
                      <tr>
          ...
          { ?>
            ...
            <a href="../imprimer"><button class="btn btn-block" name="valider" style="background-color: #efefef; color: black;"><i class="fa fa-fw fa-print"></i>Imprimer</button></a>
