...
<section class="invoice">
    ...
    <div class="row">
      ...
      <h2 class="page-header">
        ...
        <?php
        $id=$ligne->vacataire->id;
        $nom=$ligne->vacataire->nom_vacataire;
        $prenom=$ligne->vacataire->prenom_vacataire;
        $daterec=$ligne->vacataire->dateRecrut;
        $somme=$ligne->vacataire->somme;
        $cin=$ligne->vacataire->CIN;
...
<ol class="breadcrumb">
        <li>
        <?= $this->Html->link('<i class="fa fa-dashboard"></i> '.__('Back'), ['action' => 'vacataireDocument',$id], ['escape' => false]) ?>
        </li>
      </ol>
