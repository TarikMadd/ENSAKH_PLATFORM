            ...
            <div class="col-xs-12">
              <div class="box">
                ...
                <div class="box-body table-responsive no-padding">
                  ...
                  <tr>
                    <td><?php echo $i;?></td>
                  <td><?php echo $demande['nom_vacataire']." ".$demande['prenom_vacataire'];?></td>
                  <td><?php echo $demande['sous_grade'];?></td>
                  <td><?php echo $demande['duree_ab']." jour(s)";?></td>
                  <td><a href="traitementabsvac/<?php echo $demande['id'];?>"><span class="label label-primary">Traiter</span></a></td>
                  </tr>
