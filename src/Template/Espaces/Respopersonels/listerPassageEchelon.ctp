      ...
      <div class="box" >
        ...
        <div class="box-body table-responsive no-padding">
         <div class="panel panel-primary">
                    ...
                    <div class="panel-heading"><h4>    - Avancement de grade pour les professeurs permanents     :
</h4>
                    </div>
              ...
              {?>
               <tr>
                              ...
                              <td class="actions" style="white-space:nowrap">
                                <?= $this->Html->link(__('Echelon Suivant'), ['action' => 'passerEchelon', $professeursGrade->id,$professeursGrade->echelon,$professeursGrade->grade->nomGrade,$professeursGrade->sous_grade], ['class'=>'btn btn-warning btn-xs']  ) ?>
