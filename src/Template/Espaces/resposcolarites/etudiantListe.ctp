...
<section class="content-header">
  <h1>
    ...
    <div class="pull-right">
      ...
      <?= $this->Html->link(__('Imprimer la Liste'), ['action' => 'printListeEtudiant'], ['class'=>'btn btn-info btn-xs']) ?></div>
  </h1>
</section>
    ...
    <div class="col-xs-12">
      <div class="box">
        <div class="box-header">
          ...
          <div>
            <?php 
              echo $this->Form->create($etudiants,['class'=>'col-lg-6','data-toggle'=>'validator', 'role'=>'form','url'=>'/resposcolarites/sortClasse']) ;
        ...
        <div class="box-body table-responsive  no-padding">
          <table class="table table-bordered">
            <tr >
              ...
              <th class="active">Action sur l'edition</th>
            </tr>
