...
<div>
    ...
    <div class="content-wrappe">
        ...
        <section class="content">
            <div class="row">
                <div class="col-md-3">
                    <a href="<?php echo $this->Url->build('/resposcolarites/envoyerNvSco'); ?>" class="btn btn-primary btn-block margin-bottom">Composer</a>
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body no-padding">
                            ...
                            <div class="mailbox-read-info">
                                ...
                                <h5><b>De : </b><?php  if(strcmp($msg['role'],'etudiant') == 0) echo 'Etudiant '.$msg['username']; else echo 'Professeur '.$msg['username']; ?></h5>
                                <?php endif ?>

                                <?php if(strcmp($me,'me') == 0): ?>
                                <h5><b>A : </b><?php  if(strcmp($msg['role'],'etudiant') == 0) echo 'Etudiant '.$msg['username']; else echo 'Professeur '.$msg['username']; ?></h5>
                                <?php endif ?>
