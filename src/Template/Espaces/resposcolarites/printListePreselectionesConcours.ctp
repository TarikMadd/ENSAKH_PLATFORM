...
<br />
     <h5>
      ...
      $concr = $preinscription->concour->niveau->libile." ".$preinscription->concour->filiere->libile;
      endforeach;
      ?>
            <?php echo "Liste des Présélectionnés au concours"." ".$concr;   
            ?>
</h5>   
