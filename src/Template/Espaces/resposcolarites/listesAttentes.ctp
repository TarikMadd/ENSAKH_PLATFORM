...
<section class="content-header">
  <h1>
    ...
    <?= $this->Html->link(__('Imprimer la Liste'), ['action' => 'printListeAttente'], ['class'=>'btn btn-info btn-xs']) ?>
  </div>
  </h1>
</section>
          ...
          <div class="box-tools">
            <form action="/resposcolarites/find_attente" method="POST" id="frmRecherche">
              <div class="input-group input-group-sm"  style="width: 180px;">
                ...
                <script>
                 var srce = "<?php echo Router::url(array('controller' => 'Resposcolarites', 'action' => 'getAllAttenteByCne')); ?>";
                 ...
                 $('#fltrs').on('change', function() {
                  ...
                  switch (mtf) {
                    case 'cne':  
                       srce = "<?php echo Router::url(array('controller' => 'Resposcolarites', 'action' => 'getAllAttenteByCne')); ?>";
                        break;
                    case 'nom':   
                        srce = "<?php echo Router::url(array('controller' => 'Resposcolarites', 'action' => 'getAllAttenteByNom')); ?>";
                        break;
                    case 'prenom':   
                        srce = "<?php echo Router::url(array('controller' => 'Resposcolarites', 'action' => 'getAllAttenteByPrenom')); ?>";
                        break;
                    default:
                        srce = "<?php echo Router::url(array('controller' => 'Resposcolarites', 'action' => 'getAllAttenteByCne')); ?>";
                        break;
