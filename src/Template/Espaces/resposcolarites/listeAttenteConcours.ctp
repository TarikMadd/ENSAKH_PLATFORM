...
<section class="content-header">
  ...
  <h1>
    ...
    <?= $this->Html->link(__('Imprimer la Liste'), ['action' => 'printListeAttenteConcours', $cncrId], ['class'=>'btn btn-info btn-xs']) ?>
  </div>
  </h1>
</section>
    ...
    <div class="col-xs-12">
      <div class="box">
        <div class="box-header">
          <h3 class="box-title"><?= __('Liste ') ?> d'attente</h3>
           <div>
             <?php 
              echo $this->Form->create($preinscriptions,['class'=>'col-lg-6','data-toggle'=>'validator', 'role'=>'form','url'=>'/resposcolarites/liste-attente-concours']) ;
          ...
          <div class="box-tools">
            <form action="/resposcolarites/find_attente" method="POST" id="frmRecherche">
              <div class="input-group input-group-sm"  style="width: 180px;">
                ...
                <script>
                 var srce = "<?php echo Router::url(array('controller' => 'Resposcolarites', 'action' => 'getAllAttenteConcoursByCne', $cncrId)); ?>";
                 ...
                 $('#fltrs').on('change', function() {
                  ...
                  switch (mtf) {
                    case 'cne':  
                       srce = "<?php echo Router::url(array('controller' => 'Resposcolarites', 'action' => 'getAllAttenteConcoursByCne', $cncrId)); ?>";
                        break;
                    case 'nom':   
                        srce = "<?php echo Router::url(array('controller' => 'Resposcolarites', 'action' => 'getAllAttenteConcoursByNom', $cncrId)); ?>";
                        break;
                    case 'prenom':   
                        srce = "<?php echo Router::url(array('controller' => 'Resposcolarites', 'action' => 'getAllAttenteConcoursByPrenom', $cncrId)); ?>";
                        break;
                    default:
                        srce = "<?php echo Router::url(array('controller' => 'Resposcolarites', 'action' => 'getAllAttenteConcoursByCne', $cncrId)); ?>";
                        break;
            ...
            <?php foreach ($preinscriptions as $preinscription): ?>
              <tr>
                ...
                <td class="actions" style="white-space:nowrap">
                 ...
                 <?= $this->Html->link(__('Migrer'), ['action' => 'Migrer', $preinscription->id], ['confirm' => __('Confirmer?'), 'class'=>'btn btn-warning btn-xs']) ?>
                </td>
              </tr>
            <?php endforeach; ?>
          </table>
