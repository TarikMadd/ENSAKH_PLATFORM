...
<section class="content-header">
  ...
  <h1>
    ...
    <?= $this->Html->link(__('Imprimer la Liste'), ['action' => 'printListePreinscriptionConcours', $cncrId], ['class'=>'btn btn-info btn-xs']) ?>
  </div>
  </h1>
</section>
      ...
      <div class="box">
        <div class="box-header">
          <h3 class="box-title"><?= __('Liste des') ?> Pré Inscriptions</h3>
           ...
           <div>
             <?php 
              echo $this->Form->create($preinscriptions,['class'=>'col-lg-6','data-toggle'=>'validator', 'role'=>'form','url'=>'/resposcolarites/liste-preinscris-concours']) ;
          ...
          <div class="box-tools">
            <form action="/resposcolarites/find_preinscriptions" method="POST" id="frmRecherche">
              <div class="input-group input-group-sm"  style="width: 180px;">
                ...
                <script>
                 var srce = "<?php echo Router::url(array('controller' => 'Resposcolarites', 'action' => 'getAllPreInscriptionsConcoursByCne', $cncrId)); ?>";
                 ...
                 $('#fltrs').on('change', function() {
                  ...
                  switch (mtf) {
                    case 'cne':  
                       srce = "<?php echo Router::url(array('controller' => 'Resposcolarites', 'action' => 'getAllPreInscriptionsConcoursByCne', $cncrId)); ?>";
                        break;
                    case 'nom':   
                        srce = "<?php echo Router::url(array('controller' => 'Resposcolarites', 'action' => 'getAllPreInscriptionsConcoursByNom', $cncrId)); ?>";
                        break;
                    case 'prenom':   
                        srce = "<?php echo Router::url(array('controller' => 'Resposcolarites', 'action' => 'getAllPreInscriptionsConcoursByPrenom', $cncrId)); ?>";
                        break;
                    default:
                        srce = "<?php echo Router::url(array('controller' => 'Resposcolarites', 'action' => 'getAllPreInscriptionsConcoursByCne', $cncrId)); ?>";
                        break;
