...
<section class="content-header">
  <h1>
    ...
    <?= $this->Html->link(__('Imprimer la Liste'), ['action' => 'printListePreselectiones'], ['class'=>'btn btn-info btn-xs']) ?>
  </div>
  </h1>
</section>
          ...
          <div class="box-tools">
            <form action="/resposcolarites/find_preselections" method="POST" id="frmRecherche">
              <div class="input-group input-group-sm"  style="width: 180px;">
                ...
                <script>
                 var srce = "<?php echo Router::url(array('controller' => 'Resposcolarites', 'action' => 'getAllPreSelectionsByCne')); ?>";
                 ...
                 $('#fltrs').on('change', function() {
                  ...
                  switch (mtf) {
                    case 'cne':  
                       srce = "<?php echo Router::url(array('controller' => 'Resposcolarites', 'action' => 'getAllPreSelectionsByCne')); ?>";
                        break;
                    case 'nom':   
                        srce = "<?php echo Router::url(array('controller' => 'Resposcolarites', 'action' => 'getAllPreSelectionsByNom')); ?>";
                        break;
                    case 'prenom':   
                        srce = "<?php echo Router::url(array('controller' => 'Resposcolarites', 'action' => 'getAllPreSelectionsByPrenom')); ?>";
                        break;
                    default:
                        srce = "<?php echo Router::url(array('controller' => 'Resposcolarites', 'action' => 'getAllPreSelectionsByCne')); ?>";
                        break;
          ...
          <table class="table table-hover">
            <tr>
              ...
              <th><?= 
                ...
                ?></th>
              <th><?php
                echo $this->Form->button('Tous Admis ?', ['type' => 'button','id'=>'preselecteGroupe','style'=> 'margin-right: 2px; ']);
