            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <div class="box box-primary">
                        ...
                        <!-- /.box-header -->
                        <form action="/Ensaksite/resposcolarites/supprimerMsg" method="post" name="form1" >
                            <div class="box-body no-padding">
                                ...
                                <div class="table-responsive mailbox-messages">
                                    ...
                                    <table class="table table-hover table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <td class="mailbox-name"><a href="<?php $id = $msg['username']; echo $this->Url->build('/resposcolarites/lireMsgSco/'.$msg['id']); ?>"><?php  if(strcmp($msg['role'],'etudiant') == 0) echo 'ETUDIANT '.$msg['username']; else echo 'PROFESSEUR '.$msg['username']; ?></a></td>
                        ...
                        <div class="box-body no-padding">
                            ...
                            <div class="table-responsive mailbox-messages">
                                ...
                                <table class="table table-hover table-striped">
                                    ...
                                    <tr>
                                        <td class="mailbox-star"><a href="#"><i class="fa fa-star text-yellow"></i></a></td>
                                        <td class="mailbox-name"><a href="<?php $id = $msg['username']; echo $this->Url->build('/resposcolarites/lireMsgSco/readSN.'.$msg['id']); ?>"><?php  if(strcmp($msg['role'],'etudiant') == 0) echo 'ETUDIANT '.$msg['username']; else echo 'PROFESSEUR '.$msg['username']; ?></a></td>
                                        <td class="mailbox-subject"><b><?php  echo $msg['sujet']; ?></b> <?php  echo substr($msg['contenu'], 0,50)."..."; ?>
                                        </td>
                                        <td class="mailbox-attachment"></td>
                                    ...
                                    <tr>
                                        <td class="mailbox-star"><a href="#"><i class="fa fa-star text-yellow"></i></a></td>
                                        <td class="mailbox-name"><a href="<?php  echo $this->Url->build('/resposcolarites/lireMsgSco/readSD.'.$msg['id']); ?>"><?php   echo 'Aux Etudiants: '.$msg['username']; ?></a></td>
                                        <td class="mailbox-subject"><b><?php  echo $msg['sujet']; ?></b> <?php  echo substr($msg['contenu'], 0,50)."..."; ?>
                                        </td>
                                        <td class="mailbox-attachment"></td>
                                        <td class="mailbox-date"><?php echo "envoyé le:   ".$msg['date']; ?></td>
                                    ...
                                    <?php foreach ($mesMsgsDiffProfF as $msg): ?>
                                    <tr>
                                        <td class="mailbox-star"><a href="#"><i class="fa fa-star text-yellow"></i></a></td>
                                        <td class="mailbox-name"><a href="<?php  echo $this->Url->build('/resposcolarites/lireMsgSco/readSD.'.$msg['id']); ?>"><?php   echo 'Aux Professeurs: '.$msg['username']; ?></a></td>
                                        <td class="mailbox-subject"><b><?php  echo $msg['sujet']; ?></b> <?php  echo substr($msg['contenu'], 0,50)."..."; ?>
                                        </td>
                                        <td class="mailbox-attachment"></td>
                                        <td class="mailbox-date"><?php echo "envoyé le:   ".$msg['date']; ?></td>
                                    ...
                                    <?php foreach ($mesMsgsDiffProfD as $msg): ?>
                                    <tr>
                                        <td class="mailbox-star"><a href="#"><i class="fa fa-star text-yellow"></i></a></td>
                                        <td class="mailbox-name"><a href="<?php  echo $this->Url->build('/resposcolarites/lireMsgSco/readSD.'.$msg['id']); ?>"><?php   echo 'Aux Professeurs de département: '.$msg['username']; ?></a></td>
                                        <td class="mailbox-subject"><b><?php  echo $msg['sujet']; ?></b> <?php  echo substr($msg['contenu'], 0,50)."..."; ?>
                                        </td>
                                        <td class="mailbox-attachment"></td>
                                        <td class="mailbox-date"><?php echo "envoyé le:   ".$msg['date']; ?></td>
                                    ...
                                    <?php foreach ($mesMsgsDiffTE as $msg): ?>
                                    <tr>
                                        <td class="mailbox-star"><a href="#"><i class="fa fa-star text-yellow"></i></a></td>
                                        <td class="mailbox-name"><a href="<?php  echo $this->Url->build('/resposcolarites/lireMsgSco/readSD.'.$msg['id']); ?>"><?php   echo $msg['username']; ?></a></td>
                                        <td class="mailbox-subject"><b><?php  echo $msg['sujet']; ?></b> <?php  echo substr($msg['contenu'], 0,50)."..."; ?>
                                        </td>
                                        <td class="mailbox-attachment"></td>
                                        <td class="mailbox-date"><?php echo "envoyé le:   ".$msg['date']; ?></td>
                                    ...
                                    <?php foreach ($mesMsgsDiffTP as $msg): ?>
                                    <tr>
                                        <td class="mailbox-star"><a href="#"><i class="fa fa-star text-yellow"></i></a></td>
                                        <td class="mailbox-name"><a href="<?php  echo $this->Url->build('/resposcolarites/lireMsgSco/readSD.'.$msg['id']); ?>"><?php   echo $msg['username']; ?></a></td>
                                        <td class="mailbox-subject"><b><?php  echo $msg['sujet']; ?></b> <?php  echo substr($msg['contenu'], 0,50)."..."; ?>
