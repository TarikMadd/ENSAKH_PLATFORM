...
<section class="content-header">
  ...
  <h1>
    ...
    <?= $this->Html->link(__('Imprimer la Liste'), ['action' => 'printListeAdmisConcours', $cncrId], ['class'=>'btn btn-info btn-xs']) ?>
  </div>
  </h1>
</section>
          ...
          <div class="box-tools">
            <form action="/resposcolarites/find_admis" method="POST" id="frmRecherche">
              <div class="input-group input-group-sm"  style="width: 180px;">
                ...
                <script>
                 var srce = "<?php echo Router::url(array('controller' => 'Resposcolarites', 'action' => 'getAllAdmisConcoursByCne', $cncrId)); ?>";
                 ...
                 $('#fltrs').on('change', function() {
                  ...
                  switch (mtf) {
                    case 'cne':  
                       srce = "<?php echo Router::url(array('controller' => 'Resposcolarites', 'action' => 'getAllAdmisConcoursByCne', $cncrId)); ?>";
                        break;
                    case 'nom':   
                        srce = "<?php echo Router::url(array('controller' => 'Resposcolarites', 'action' => 'getAllAdmisConcoursByNom', $cncrId)); ?>";
                        break;
                    case 'prenom':   
                        srce = "<?php echo Router::url(array('controller' => 'Resposcolarites', 'action' => 'getAllAdmisConcoursByPrenom', $cncrId)); ?>";
                        break;
                    default:
                        srce = "<?php echo Router::url(array('controller' => 'Resposcolarites', 'action' => 'getAllAdmisConcoursByCne', $cncrId)); ?>";
                        break;
