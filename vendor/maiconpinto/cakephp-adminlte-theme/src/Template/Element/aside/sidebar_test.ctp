...
elseif ($us['role']=='respopersonel')
{
    ...
    <li class="treeview">
        <a href="#">
            <i class="fa fa-table"></i> <span>Professeurs Permanents</span>
            <i class="fa fa-angle-left pull-right"></i>
        </a>
        <ul class="treeview-menu">
                                       <!-- SARIH debut-->
                                       ...
                                       <li>
                                           ...
                                           <li><?php echo $this->Html->link($this->Html->tag('i', '', array('class' => 'fa fa-th-list')).'Grades ',array('controller' => 'Respopersonels','action' => 'listerGrade'), array('escape' => false)); ?>"></li>
                                           ...
                                           <li><?php echo $this->Html->link($this->Html->tag('i', '', array('class' => 'fa fa-search')).'Consultation Document ', array('controller' => 'Respopersonels','action' => 'voirDocument'), array('escape' => false)); ?>"></li>
                                           <li><?php echo $this->Html->link($this->Html->tag('i', '', array('class' => 'fa fa-file')).'Recherche des professeurs', array('controller' => 'Respopersonels','action' => 'rechercher'), array('escape' => false)); ?>"></li>
            ...
            <li><?php echo $this->Html->link('Les statistiques' ,array('controller' => 'Respopersonels','action' => ' statistiquesPrper')); ?></li>
    ...
    <li class="treeview">
        <a href="#">
            <i class="fa fa-table"></i> <span>Professeurs Vacataires</span>
            <i class="fa fa-angle-left pull-right"></i>
        </a>
        <ul class="treeview-menu">
                             <a href="#">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li><?php echo $this->Html->link('Creer compte',array('controller' => 'Respopersonels','action' => 'addvac')); ?>"></li>
                            ...
                            <li><?php echo $this->Html->link('Demandes Modification Données',array('controller' => 'Respopersonels','action' => 'voirDemandesVac')); ?>"></li>
 ...
 <li><?php echo $this->Html->link('Consultation Document ', array('controller' => 'Respopersonels','action' => 'voirrDocument')); ?>"></li>


<li><?php echo $this->Html->link('Grades et départements',array('controller' => 'Respopersonels','action' => 'statvacs')); ?>"></li>

<li><?php echo $this->Html->link('Grades',array('controller' => 'Respopersonels','action' => 'listerGradeVac')); ?>"></li>

<li><?php echo $this->Html->link('Affecter un vacataire',array('controller' => 'respopersonels','action'=>'Affecteraundepart')); ?>"></li>

<li><?php echo $this->Html->link('Affecter  Grade',array('controller' => 'respopersonels','action'=>'affectergradevac')); ?>"></li>
    ...
    <li class="treeview">
        <a href="#">
            <i class="fa fa-table"></i> <span>Fonctionnaires</span>
            <i class="fa fa-angle-left pull-right"></i>
        </a>
        <ul class="treeview-menu">
               <!-- SARIH debut-->
               ...
               <li>
                   ...
                   <li><?php echo $this->Html->link($this->Html->tag('i', '', array('class' => 'fa fa-list-ol')).'Fonctionnaires par Grade ', array('controller' => 'Respopersonels','action' => 'listerFonctGrade'), array('escape' => false)); ?>"></li>
    ...
    <li class="treeview">
        <a href="#">
            <i class="fa fa-table"></i> <span>Gestion des abscences</span>
            <i class="fa fa-angle-left pull-right"></i>
        </a>
        <ul class="treeview-menu">
    ...
    <li class="treeview">
        <a href="#">
            <i class="fa fa-table"></i> <span>Statistiques des professeurs</span>
            <i class="fa fa-angle-left pull-right"></i>
        </a>
        <ul class="treeview-menu">
    ...
    <li class="treeview">
        <a href="#">
            <i class="fa fa-table"></i> <span> Statistiques des fonctionnaires</span>
            <i class="fa fa-angle-left pull-right"></i>
        </a>
         <ul class="treeview-menu">
